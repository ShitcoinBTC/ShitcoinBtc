...
public:
    ...
    CMainParams(const MainNetOptions& opts) {
        ...
        // Shitcoin: new chain — no prior work to assume.
        consensus.nMinimumChainWork = uint256{};

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256{}; // set after launch
...
// Shitcoin: new chain — only the genesis block is checkpointed.
        ...
        chainTxData = ChainTxData{
            // Data from rpc: getchaintxstats at block 2022819
            .nTime    = 1746028449,
            .nTxCount = 3350017,
            .dTxRate  = 0.007705991158318447
        };
    }
};
...
public:
    explicit CRegTestParams(const RegTestOptions& opts)
    {
        ...
        consensus.nMinimumChainWork = uint256{};
        consensus.defaultAssumeValid = uint256{};
        // Regtest: no launch allocations — blocks are mined ad-hoc and the
        // regtest subsidy path (GetBlockSubsidyRegtest) applies at all heights.
        ...
        // Mainnet uses the full 5.25B SHIT reserve; regtest just needs non-zero
        // caps so CheckVaultYield computes real entitlements.
        consensus.nVaultReserveTotal = 100000000 * COIN;
        consensus.nVaultYearlyYieldCap = 1000000 * COIN;
