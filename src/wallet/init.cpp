...
void WalletInit::AddWalletOptions(ArgsManager& argsman) const
{
    ...
    argsman.AddArg("-vaultbtcexplorer=<url>", "Base URL of the Bitcoin explorer API used by the vault RPCs' BTC co-hold check (default: https://blockstream.info/api). The explorer is queried over HTTPS for the co-hold address's confirmed balance.", ArgsManager::ALLOW_ANY, OptionsCategory::WALLET);
